                    ...
                    <div class="post-heading">
                        @foreach ($profiles as $profile)          
                            @if ($comment->email == $profile->email)
                                ...
                                @else
                                    <div class="float-left">
                                        <img src="public/storage/profile_images/{{$profile->email}}/{{$profile->picture}}" class="img-circle avatar comment-image border border-primary mr-3" alt="user profile image">
                                    </div>
                                @endif
                            @endif
                        @endforeach
